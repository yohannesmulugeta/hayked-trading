    ...
    <>
      ...
      <section className="section section--soft">
        <div className="container sustainability-layout">
          <img className="rounded-media" src="https://images.pexels.com/photos/36040318/pexels-photo-36040318.png?auto=compress&cs=tinysrgb&w=1920" alt="Ripe Ethiopian coffee cherries" loading="lazy" />
